...
export { HoppGQLAuthBasic, HoppGQLAuthBearer, HoppGQLAuthNone, HoppGQLAuthInherit, } from "./v/2";
export { HoppGQLAuthOAuth2, HoppGQLAuth } from "./v/5";
export { HoppGQLAuthAPIKey } from "./v/4";
export declare const GQL_REQ_SCHEMA_VERSION = 5;
export declare const HoppGQLRequest: import("verzod").VersionedEntity<5, {
...
export declare function getDefaultGQLRequest(): HoppGQLRequest;
/**
 * @deprecated This function is deprecated. Use `HoppGQLRequest` instead.
 */
export declare function translateToGQLRequest(x: unknown): HoppGQLRequest;
