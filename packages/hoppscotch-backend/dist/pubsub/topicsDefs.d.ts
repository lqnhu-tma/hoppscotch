...
import { UserCollection, UserCollectionRemovedData, UserCollectionReorderData } from 'src/user-collection/user-collections.model';
...
export type TopicDef = {
    ...
    [topic: `shortcode/${string}/${'created' | 'revoked' | 'updated'}`]: Shortcode;
};
